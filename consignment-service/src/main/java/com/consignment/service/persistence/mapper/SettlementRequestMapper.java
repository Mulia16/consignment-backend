...
public interface SettlementRequestMapper {
    ...
    List<SettlementRequestEntity> searchHeaders(@Param("c") SettlementSearchCriteria criteria);
    long countHeaders(@Param("c") SettlementSearchCriteria criteria);
    List<SettlementDetailEntity> findDetailsByHeaderId(@Param("settlementId") String settlementId);
    int countOpenByReference(@Param("company") String company, @Param("store") String store,
                             @Param("settlementType") String settlementType, @Param("referenceNo") String referenceNo);
    int countExistingDetail(@Param("settlementId") String settlementId, @Param("documentType") String documentType,
                            @Param("documentNo") String documentNo, @Param("itemCode") String itemCode);
    ...
    void updateHeaderStatus(@Param("id") String id, @Param("status") String status,
                            ...
                            @Param("billedAt") Instant billedAt, @Param("settledAt") Instant settledAt);
}
